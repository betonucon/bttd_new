...
<section class="head">
    <div class="judul">
        <i class="fa fa-clone"></i> Pengambilan E-Kupon PPH
    </div>
</section>
...
<script>
    ...
    function simpan_data(){
        ...
        var tanggal=$('#datepicker').val();
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('/bukti/simpan_proses_pph/'.$id)}}?penerima="+penerima+"&tanggal="+tanggal,
                ...
                success: function(msg){
                    ...
                    if(msg=='ok'){
                        ...
                        window.open("{{url('bukti/cetak/'.$id)}}?tgl="+tanggal, '_blank');
                        location.reload();
                    }else{
                        $('#simpan_data').show();
