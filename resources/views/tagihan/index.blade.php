            ...
            <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table  id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @foreach(tagihan() as $no=>$data)
                                <tr>
                                    <td>{{$no+1}}</td>
                                    <td>{{$data->name}}</td>
                                    <td><span class="btn btn-default btn-sm" onclick="detail({{$data['id']}})"><i class="fa fa-file-pdf-o"></i></td>
                                    <td>
