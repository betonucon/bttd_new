...
<head>
  ...
  <title>BTTD (Bukti Tanda Terima Dokumen)</title>
  <link href="https://sso.krakatausteel.com/public/fav.png" rel="icon">
...
<div class="wrapper" style="background-color: #ecf0f5;">
  ...
  <aside class="main-sidebar" style="position: fixed;">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel" style="text-align:center">
        ...
        <br><p style="font-size:12px">{{substr(Auth::user()['name'],0,22)}}<br>{{substr(Auth::user()['name'],23,50)}}</p>
        <b>{{cek_role(Auth::user()['role_id'])}}</b>
      </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright © 2020 <a href="#">BTTD Online</a>.</strong>
    All rights
    reserved.
  </footer>
...
<script>
  ...
  function hanyaAngka(evt) {
        ...
        if ( charCode==47 || charCode==48 || charCode==49 || charCode==50|| charCode==51|| charCode==52|| charCode==53|| charCode==54 || charCode==55|| charCode==56|| charCode==57)
