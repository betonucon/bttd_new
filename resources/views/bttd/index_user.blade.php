            ...
            },
            {
                ...
                "render": function (data, row, type, meta) {
                    let tom = '';
                        ...
                        tom += "<span style='font-size: 11px;' class='btn btn-primary btn-xs' id='edit' name='edit' title='Lihat Detail'><i class='fa fa-search'></i></span>";
            ...
            },
            {
                ...
                "render": function (data, row, type, meta) {
                    let btn = '';
                        ...
                        if(data.sts_faktur==1){
                            btn += '<span class="btn btn-success btn-xs" onclick="edit('+data.id+')"><i class="fa fa-pencil"></i></span>_'
                                    +'<span class="btn btn-danger btn-xs" onclick="hapus('+data.id+')"><i class="fa fa-remove"></i></span>';
                        }else{
                            btn += '<span class="btn btn-success btn-xs" onclick="edit_faktur('+data.id+')"><i class="fa fa-pencil"></i></span>_'
                                    +'<span class="btn btn-danger btn-xs" onclick="hapus('+data.id+')"><i class="fa fa-remove"></i></span>';
                        }
