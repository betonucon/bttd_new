            ...
            <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table  id="tabel_id" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @foreach(bttd($bulan,$tahun) as $no=>$data)
                                <tr>
                                    <td>{{$no+1}}</td>
                                    @if($data['proses']==0)
                                        <td></td>
                ...
                "render": function (data, row, type, meta) {
                    let btn = '';
                        ...
                        btn += "<button style='font-size: 11px;' class='btn btn-primary' id='detail' name='detail' title='Lihat Detail'><i class='fa fa-search'></i></button>"+
                                "_<button style='font-size: 11px;' class='btn btn-success' id='edit' name='edit' title='Edit Data'><i class='fa fa-pencil'></i></button>";
